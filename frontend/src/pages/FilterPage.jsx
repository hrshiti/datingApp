...
export default function FilterPage() {
  ...
  return (
    <div className="min-h-screen heart-background flex flex-col relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-4 py-2">
          <div className="flex items-center justify-between">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-3 py-1.5 text-xs font-semibold text-[#757575] hover:text-[#FF1744] transition-colors"
            >
              Reset
            </motion.button>
          </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide pb-24">
        <div className="max-w-2xl mx-auto px-4 py-4">
          ...
          <motion.div
            ...
            className="mb-4 bg-white rounded-xl p-4 shadow-sm border border-[#FFB3BA]/20"
          >
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-[#FFE5E5] border-2 border-[#FFB3BA]/30 rounded-lg text-[#212121] font-semibold text-sm focus:outline-none focus:border-[#FF1744] transition-all"
                />
              </div>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="px-3 py-1 bg-gradient-to-r from-[#FFE5E5] to-[#FFF0F0] rounded-lg text-sm font-bold text-[#FF1744]">
            ...
            <input
              ...
              className="w-full h-2 bg-[#FFE5E5] rounded-lg appearance-none cursor-pointer accent-[#FF1744]"
            />
          </motion.div>
                ...
                <motion.button
                  ...
                  className={`px-3 py-1.5 rounded-lg font-semibold text-xs transition-all ${
                    filters.lookingFor.includes(option.value)
                      ? 'bg-gradient-to-r from-[#FF1744] to-[#FF6B9D] text-white shadow-sm'
                      : 'bg-[#FFE5E5] text-[#212121] border border-[#FFB3BA]/30 hover:border-[#FF1744]'
                  }`}
                >
                  {option.label}
                </motion.button>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              {filters.interests.length > 0 && (
                <span className="px-2 py-0.5 bg-[#FF1744] text-white text-xs font-bold rounded-full">
                ...
                <motion.button
                  ...
                  className={`px-3 py-1.5 rounded-lg font-semibold text-xs transition-all ${
                    filters.interests.includes(interest)
                      ? 'bg-gradient-to-r from-[#FFE5E5] to-[#FFF0F0] text-[#FF1744] border-2 border-[#FF1744] shadow-sm'
                      : 'bg-[#FFE5E5] text-[#212121] border border-[#FFB3BA]/30 hover:border-[#FF1744]'
                  }`}
                >
                  {interest}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-md border-t-2 border-[#FFB3BA]/30 shadow-lg p-3">
        <div className="max-w-2xl mx-auto flex gap-2">
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="flex-1 px-4 py-2.5 bg-gradient-to-r from-[#FF1744] to-[#FF6B9D] text-white rounded-lg font-semibold text-sm shadow-md hover:shadow-lg transition-all"
          >
            Apply Filters
          </motion.button>
        </div>
