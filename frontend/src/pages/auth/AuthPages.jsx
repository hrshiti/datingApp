          ...
          <div className="bg-white rounded-3xl shadow-lg p-5 sm:p-8">
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-2xl focus:border-rose-600 focus:outline-none transition-colors text-black"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-rose-600 hover:bg-rose-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-4 rounded-2xl transition-all transform hover:scale-105 active:scale-95 disabled:transform-none"
              >
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-4 border-2 border-gray-200 rounded-2xl focus:border-rose-600 focus:outline-none transition-colors text-black"
                />
              </div>
    ...
    return (
      <div className="h-screen heart-background flex items-center justify-center p-3 sm:p-4 overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-4 sm:mb-8">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-rose-100 rounded-full mx-auto mb-3 sm:mb-4 flex items-center justify-center">
              <Mail className="w-6 h-6 sm:w-8 sm:h-8 text-rose-600" />
            </div>
            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex justify-center items-center gap-1.5 sm:gap-2 px-1">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      className="flex-1 max-w-[45px] sm:max-w-[50px] h-12 sm:h-14 text-center text-xl sm:text-2xl font-bold border-2 border-gray-200 rounded-xl focus:border-rose-600 focus:outline-none transition-colors text-black"
                    />
                  ))}
                </div>
              </div>
              ...
              <div className="text-center">
                <button className="text-gray-600 hover:text-black font-medium text-sm">
                  Didn't receive code? <span className="text-rose-600">Resend</span>
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="h-screen heart-background flex items-center justify-center p-3 sm:p-4 overflow-hidden">
        ...
        <div className="w-full max-w-md text-center relative z-10">
          ...
          <button
            ...
            className="bg-rose-600 hover:bg-rose-700 text-white font-semibold py-4 px-8 rounded-2xl transition-all transform hover:scale-105 active:scale-95"
          >
            Continue
          </button>
        </div>
