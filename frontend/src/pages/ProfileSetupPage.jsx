    ...
    <div className="h-screen heart-background flex items-center justify-center p-3 sm:p-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        >
          ...
          <div className="space-y-6 sm:space-y-8 max-h-[65vh] overflow-y-auto pr-2">
            ...
            >
              <label className="block text-sm sm:text-base font-semibold text-[#212121] mb-3">
                Photos <span className="text-[#FF91A4]">*</span>
              </label>
              <PhotoUpload
                photos={photos}
                onChange={setPhotos}
            ...
            >
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border-2 border-[#FFB6C1] rounded-xl sm:rounded-2xl text-sm sm:text-base text-[#212121] bg-white focus:outline-none focus:ring-2 focus:ring-[#FF91A4] focus:ring-opacity-20 focus:border-[#FF91A4] transition-all resize-none"
              />
            ...
            <motion.div
              ...
              className="border-2 border-[#FFB6C1] rounded-xl sm:rounded-2xl p-4"
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center mb-2">
                    <Camera className="w-5 h-5 text-[#FF91A4] mr-2" />
                ...
                <motion.button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-medium transition-all ${
                    showVerification
                      ...
                      : 'bg-[#FFE4E1] text-[#FF91A4] hover:bg-[#FF91A4] hover:text-white'
                  }`}
                >
          ...
          {/* Complete Button */}
          <div className="pt-4 sm:pt-6 mt-4 sm:mt-6 border-t border-[#FFB6C1]">
            <motion.button
              ...
              className="w-full bg-[#FF91A4] hover:bg-[#FF69B4] disabled:bg-[#E0E0E0] disabled:cursor-not-allowed text-white font-semibold py-3 sm:py-4 rounded-xl sm:rounded-2xl transition-all flex items-center justify-center gap-2 shadow-lg disabled:transform-none"
            >
