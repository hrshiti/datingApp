...
export default function AdminActivityLogsPage() {
  ...
  const getCategoryColor = (category) => {
    const colors = {
      ...
      settings: 'bg-[#F5F5F5] text-gray-700',
      verification: 'bg-purple-100 text-purple-700'
    };
    return colors[category] || 'bg-[#F5F5F5] text-gray-700';
  };
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6">
            <div className="bg-white rounded-xl p-3 md:p-4 shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E8E8E8]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm text-[#616161]">Total Logs</p>
            ...
            <div className="bg-white rounded-xl p-3 md:p-4 shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E8E8E8]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm text-[#616161]">Today</p>
            ...
            <div className="bg-white rounded-xl p-3 md:p-4 shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E8E8E8]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm text-[#616161]">This Week</p>
                  <p className="text-xl md:text-2xl font-bold text-[#64B5F6]">{stats.thisWeek}</p>
                </div>
                <Calendar className="w-5 h-5 md:w-6 md:h-6 text-[#64B5F6]" />
              </div>
            </div>
            <div className="bg-white rounded-xl p-3 md:p-4 shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E8E8E8]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm text-[#616161]">This Month</p>
          ...
          <div className="bg-white rounded-xl shadow-[0_4px_16px_rgba(0,0,0,0.08)] border border-[#E8E8E8] overflow-hidden">
                  ...
                  {filteredLogs.map((log, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-4">
                          <span className="text-sm text-[#616161]">{log.admin}</span>
                        </td>
                        <td className="px-4 py-4">
                          <span className="text-sm text-[#616161]">{log.target}</span>
                        </td>
                        <td className="px-4 py-4">
                  ...
                  >
                    <div className="flex items-start gap-3 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-[#616161] mb-1">Admin: {log.admin}</p>
                        <p className="text-xs text-[#616161] mb-1">Target: {log.target}</p>
            ...
            {filteredLogs.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-[#616161]">No activity logs found</p>
              </div>
            )}
          </div>
        </div>
