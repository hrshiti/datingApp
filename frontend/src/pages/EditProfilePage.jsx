        ...
        <div className="max-w-2xl mx-auto px-4 py-6">
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-[#FF1744] to-[#FF6B9D] rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3 bg-[#FFE5E5] border-2 rounded-xl text-[#212121] placeholder-[#757575] focus:outline-none transition-all ${
                      errors.name ? 'border-[#FF1744]' : 'border-[#FFB3BA]/30 focus:border-[#FF1744]'
                    }`}
                  />
                </div>
                {errors.name && (
                  <motion.p
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="text-sm text-[#FF1744] mt-1 ml-1"
                  >
                    {errors.name}
                  </motion.p>
                )}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-3 bg-[#FFE5E5] border-2 rounded-xl text-[#212121] placeholder-[#757575] focus:outline-none transition-all ${
                      errors.email ? 'border-[#FF1744]' : 'border-[#FFB3BA]/30 focus:border-[#FF1744]'
                    }`}
                  />
                </div>
                {errors.email && (
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    maxLength={10}
                    className={`w-full pl-12 pr-4 py-3 bg-[#FFE5E5] border-2 rounded-xl text-[#212121] placeholder-[#757575] focus:outline-none transition-all ${
                      errors.phone ? 'border-[#FF1744]' : 'border-[#FFB3BA]/30 focus:border-[#FF1744]'
                    }`}
                  />
                </div>
                {errors.phone && (
            ...
            <motion.button
              ...
              className={`w-full mt-6 py-3 rounded-xl font-semibold text-white shadow-md transition-all ${
                isLoading
                  ...
                  : 'bg-gradient-to-r from-[#FF1744] to-[#FF6B9D] hover:shadow-lg'
              }`}
            >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 bg-white border-2 border-[#FF1744] text-[#FF1744] rounded-xl font-semibold shadow-md hover:bg-[#FFE5E5] transition-all"
            >
              Edit All Details
            </motion.button>
          </motion.div>
