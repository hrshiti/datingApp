          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="p-1.5 hover:bg-[#FFE5E5] rounded-lg transition-colors sm:hidden"
              >
                <ArrowLeft className="w-5 h-5 text-[#212121]" />
              </motion.button>
              <div className="flex items-center gap-2">
                <MessageCircle className="w-5 h-5 text-[#FF1744]" />
        ...
        <div className="max-w-2xl mx-auto px-4 py-4">
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#FF1744] to-[#FF6B9D] p-1">
          ...
          >
            ...
            <div className="space-y-2">
              {chats.map((chat, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl p-4 shadow-sm border border-[#FFB3BA]/20 hover:shadow-md transition-all cursor-pointer"
                >
                  <div className="flex items-center gap-3">
                    {/* Avatar */}
                    <div className="relative flex-shrink-0">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#FFE5E5] to-[#FFF0F0] p-0.5">
                        <img
                          src={chat.avatar}
                          alt={chat.name}
                          className="w-full h-full rounded-full object-cover"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {chat.unread > 0 && (
                          <span className="ml-2 px-2 py-0.5 bg-[#FF1744] text-white text-xs font-bold rounded-full flex-shrink-0">
                            {chat.unread}
                          </span>
                        )}
                      </div>
            ...
            {chats.length === 0 && (
              ...
              >
                <div className="w-20 h-20 bg-gradient-to-br from-[#FFE5E5] to-[#FFF0F0] rounded-full flex items-center justify-center mx-auto mb-4">
                  <MessageCircle className="w-10 h-10 text-[#FF1744]" />
                </div>
