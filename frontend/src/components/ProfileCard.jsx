    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide pb-20 sm:pb-0 -mt-2">
          ...
          <div className="relative w-full h-[70vh] bg-gradient-to-br from-[#FFE5E5] via-[#FFF0F0] to-[#FFE5E5]">
          {profile.photos && profile.photos.length > 0 ? (
            <>
              ...
              {matchScore && (
                <motion.div
                  ...
                  animate={{ opacity: 1, scale: 1 }}
                  className="absolute top-4 right-4 bg-gradient-to-br from-[#FF1744] to-[#FF6B9D] text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg z-10"
                >
                  {matchScore}% Match
                </motion.div>
              )}
            ...
            <div className="w-full h-full flex items-center justify-center">
              <div className="text-8xl text-[#FF1744] font-bold">
          ...
          <div className="bg-white">
            ...
            <div className="mb-5">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {profile.personality?.social && (
                  <span className="px-3 py-1.5 bg-[#FFE5E5] text-[#212121] rounded-full text-xs font-medium capitalize">
              ...
              <div className="mb-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {Object.entries(profile.personality).map(([key, value]) => (
                    value && (
                      <span key={key} className="px-3 py-1.5 bg-[#FFF0F0] text-[#212121] rounded-full text-xs font-medium capitalize border border-[#FFB3BA]/20">
                        {value.replace('-', ' ')}
                      </span>
                    )
                  ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile.optional.languages.map((lang) => (
                        <span key={lang} className="px-3 py-1.5 bg-[#FFE5E5] text-[#212121] rounded-full text-xs font-medium">
                          {lang}
                        </span>
                      ))}
                    </div>
            ...
            <div className="flex items-center justify-center gap-6 p-6 bg-white border-t border-[#FFB3BA]/20 pb-8">
              <motion.button
                onClick={onPass}
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className="w-16 h-16 rounded-full bg-gradient-to-br from-[#FF1744] to-[#FF6B9D] flex items-center justify-center shadow-lg hover:shadow-xl transition-all"
              >
